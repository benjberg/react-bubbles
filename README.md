...
A token is used to authenticate a user. it allows the user to access protected branches of the app as long as they have the token.

- [ ] What steps can you take in your web apps to keep your data secure?

some steps are to get profesional pen. testing. we could do the testing ourselves before shipping to make sure there are no data breaches as well. Also scanning your app frequently for vulnerabilites as well as backing your data up.

- [ ] Describe how web servers work.

web servers process incoming network request over http/other protocols (always follow proto), the server stores, processes and delivers webpages.  
